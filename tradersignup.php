...
session_start();
 ...
 include('connection.php');
    ...
    if(isset($_POST['submittrader']))
    {
            ...
            if(empty( $_POST['Trader_shop'])){
                $errcount += 1;
                $terms_error="please select trader category";
            }
            ...
            if($errcount ==0){
                ...
                if (!filter_var($semail, FILTER_VALIDATE_EMAIL)) 
                    ...
                    oci_bind_by_name($data_qu, ':s_name', $catogory);
                    ...
                    {
                        $errcount += 1;
                        $email_error = "Category already exists";
                    }
                ...
                if($password == $confirmpass)
                {
                        ...
                        if($errcount == 0)
                        {
                            ...
                            oci_bind_by_name($stid, ':trader_category',$catogory);
